...
import { EDIT_PAGE } from "../../ScreenRouterLinks";
    ...
    return (
        ...
        <Card mode="outlined" style={[styles.card, {
            ...
            <Card.Actions>
                ...
                <IconButton icon="pencil" mode="outlined" onPress={(_) => {
                    navigation.navigate(EDIT_PAGE, { pokemonId: pokemonData.id, buttonText: "Update" });
                }} style={styles.icons}/>
            </Card.Actions>
        </Card>
        </View>
