...
/**
 * Returns me a container color as number colors given Pokemon Type
 * 
 * @param type {@link ElementType} of a pokemon
 * @returns an AlphaColor Object with corresponding colors in RGB spectrum
 */
...
/**
 * Returns me a text color as number colors given Pokemon Type
 * 
 * @param type {@link ElementType} of a pokemon
 * @returns an AlphaColor Object with corresponding colors in RGB spectrum
 */
...
/**
* Get me a chip color from provided pokemonType
* 
* @param type {@link ElementType} of a pokemon
* @returns an ChipColorsType Object with corresponding colors in RGB spectrum for container and text color
* @see {@link ChipColorsType}
*/
